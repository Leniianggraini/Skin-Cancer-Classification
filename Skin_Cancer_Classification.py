...
MODELSPATH = 'C:/Users/USER/models/'
DATAPATH = 'C:/Users/USER/data/'


def render_header():
    st.write("""
        <p align="center"> 
            <H1> Skin Cancer Classification 
        </p>
...
def main():
    st.sidebar.header('Skin Cancer Classification by Leni Anggraini')
    st.sidebar.subheader('Choose a page to proceed:')
    page = st.sidebar.selectbox("", ["Sample Data", "Upload Your Image"])

    if page == "Sample Data":
        st.header("Data prediction example for skin cancer ")
        st.markdown("""
        **This may be why you are here. Let us provide you with some predictions **
